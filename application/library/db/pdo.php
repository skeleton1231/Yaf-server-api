...
//            }
    ...
    public function close() {
        ...
        $s = print_r($this->_linkID , 1 );
        //Common::globalLogRecord('pdo close connection: ', $s);
        $this->_linkID = null;
    }
    ...
    public function error() {
        ...
        Common::globalLogRecord('sql-error',$this->error);

        header('Content-type: application/json');
        $response = Common::getFailRes(SYSTEM_FAIL, STATUS_FAIL);
        echo $response;
        die();
