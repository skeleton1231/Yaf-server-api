...
//        }
    ...
    public function getListFormat($item){

        $num = count($item);

        $more =   (($this->number + $num) < $this->count) ? 1 : 2;
    ...
    protected function setInitLimit(){

        $number = ($this->page - 1) * $this->pageSize;
